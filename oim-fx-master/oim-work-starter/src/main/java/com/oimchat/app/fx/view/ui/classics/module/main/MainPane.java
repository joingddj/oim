package com.oimchat.app.fx.view.ui.classics.module.main;
...
public class MainPane extends BorderPane {
	...
	private void initComponent() {
		...
		findTextField.setStyle("-fx-prompt-text-fill:#ffffff;-fx-background-color:null");

		Image image = ImageLoadUtil.getImageByClassPath("/general/view/theme/classics/images/main/search/search_icon.png");
		...
		functionBox.setPadding(new Insets(2, 5, 5, 2));
		functionBox.setStyle("-fx-background-color:null");
		...
		bottomBorderPane.setBackground(Background.EMPTY);

		// bottomBorderPane.setStyle("-fx-background-color:rgba(230, 230, 230)");
	...
	private void initDefault() {
		Image logoIamge = new Image(this.getClass().getResource("/general/view/theme/classics/images/main/title_logo.png").toExternalForm(), true);
	...
	public void addTab(IconTab tab, Node node) {
		tabPane.add(tab, node);
	}
