...
public class UserDataPane extends BorderPane {
	...
	private final ImagePane headImagePanel = new ImagePane();
	...
	private void initComponent() {
		...
		headImagePanel.setImageSize(60);
		headImagePanel.setImageRadius(60);
...
//		businessPane.setBackground(Background.EMPTY);
		...
		businessPane.setStyle("-fx-background-color:null");
