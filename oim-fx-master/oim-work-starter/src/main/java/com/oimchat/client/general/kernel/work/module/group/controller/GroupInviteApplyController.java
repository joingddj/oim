...
public class GroupInviteApplyController extends AbstractMaterial {

	public GroupInviteApplyController(AppContext appContext) {
		super(appContext);
	}
	...
	public void queryApplyDataReceiveList(
		...
		hanlder.queryInviteApplyList(query, page, (info, pr) -> {
