...
package com.oimchat.client.general.common.task;
...
/**
 * Description <br>
 * Date 2020-11-19 21:00:45<br>
 * 
 * @author XiaHui [onlovexiahui@qq.com]<br>
 * @since 1.0.0
 */

public class RunExecutor extends AbstractMaterial {

	protected final Logger logger = LoggerFactory.getLogger(this.getClass());
	private final ExecutorService executor = ThreadPoolBuilder.build();

	public RunExecutor(AppContext appContext) {
		super(appContext);
	}
