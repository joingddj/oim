...
public class ContactCategoryEventObservable extends AbstractObservable<GroupCategoryEventListener> {

	public ContactCategoryEventObservable(AppContext appContext) {
		super(appContext);
	}
}
