...
package com.oimchat.client.platform.common.run.initializer.start.essential;
...
public class ServerStartInitializer implements StartInitializer {

	@Override
	public void initialize(AppContext appContext) {
		ServerAddressConfigManager m = appContext.getObject(ServerAddressConfigManager.class);
		m.load();
	}
