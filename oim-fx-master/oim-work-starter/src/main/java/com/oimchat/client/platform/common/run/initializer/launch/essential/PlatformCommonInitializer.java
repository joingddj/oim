...
import com.oimchat.client.platform.kernel.work.module.im.neaten.MessageReceiveContentNeatenImpl;
import com.oimchat.client.platform.kernel.work.module.im.neaten.MessageSendContentNeatenImpl;
...
public class PlatformCommonInitializer implements LaunchInitializer {

	@Override
	public void initialize(AppContext appContext) {
		appContext.register(MessageSendContentNeaten.class, MessageSendContentNeatenImpl.class);
		appContext.register(MessageReceiveContentNeaten.class, MessageReceiveContentNeatenImpl.class);
	}
