...
package com.oimchat.client.platform.fx.run.initializer.start.essential;
...
import com.oimchat.client.platform.common.run.initializer.start.essential.ServerStartInitializer;
...
import com.oimchat.client.platform.fx.view.impl.classics.ForgetPasswordViewImpl;
import com.oimchat.client.platform.fx.view.impl.classics.LoginViewImpl;
import com.oimchat.client.platform.fx.view.impl.classics.NetSettingViewImpl;
import com.oimchat.client.platform.fx.view.impl.classics.RegisterViewImpl;
import com.onlyxiahui.app.context.AppContext;
import com.onlyxiahui.app.initializer.StartInitializer;
...
public class ViewStartInitializer implements StartInitializer {

	@Override
	public void initialize(AppContext appContext) {
		initThemeConfig(appContext);
		...
		LoginView lv = appContext.getObject(LoginView.class);
		lv.setVisible(true);
	}
	...
	public List<Class<?>> onAfter() {
		...
		list.add(ServerStartInitializer.class);
		return list;
	}

	private Color initThemeConfig(AppContext appContext) {
		...
		if (null != theme) {
			...
			backgroundColor = Color.color(backgroundColorData.getRed(), backgroundColorData.getGreen(), backgroundColorData.getBlue(), backgroundColorData.getOpacity());
			themeColor = Color.color(themeColorData.getRed(), themeColorData.getGreen(), themeColorData.getBlue(), themeColorData.getOpacity());
			StageBox sb = appContext.getObject(StageBox.class);
			sb.setBackgroundColor(backgroundColor);
			sb.setThemeColor(themeColor);
			try {
				sb.setBackgroundImageUrl(new URL(theme.getBackgroundImageUrl()));
			} catch (MalformedURLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			sb.setLogoImageUrl(this.getClass().getResource("/general/resources/common/images/logo/logo_64.png"));
		}
		return themeColor;
	}
}
