...
import com.oimchat.client.general.common.sender.SenderBuildFactory;
...
public class EssentialSenderInitializer implements LaunchInitializer {

	@Override
	public void initialize(AppContext appContext) {
		appContext.putFactory(SenderBuildFactory.class);
	}
