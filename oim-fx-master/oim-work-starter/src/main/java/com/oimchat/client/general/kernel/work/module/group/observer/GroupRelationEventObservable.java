...
public class GroupRelationEventObservable extends AbstractObservable<GroupRelationEventListener> {

	public GroupRelationEventObservable(AppContext appContext) {
		super(appContext);
	}
}
