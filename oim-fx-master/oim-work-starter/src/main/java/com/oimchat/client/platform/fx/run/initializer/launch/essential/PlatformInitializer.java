...
import com.oimchat.client.platform.swing.view.impl.TrayViewImpl;
...
public class PlatformInitializer implements LaunchInitializer {
	...
	public void initialize(AppContext appContext) {
		...
		run.execute(() -> {
			appContext.getObject(FaceManager.class);
		});
	}
	...
	private void initTray(AppContext appContext) {
		appContext.register(TrayView.class, TrayViewImpl.class);
		appContext.getObject(TrayView.class);
	}
}
