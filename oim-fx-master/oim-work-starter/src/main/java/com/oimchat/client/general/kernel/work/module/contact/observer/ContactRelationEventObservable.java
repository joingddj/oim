...
public class ContactRelationEventObservable extends AbstractObservable<ContactRelationEventListener> {

	public ContactRelationEventObservable(AppContext appContext) {
		super(appContext);
	}
}
