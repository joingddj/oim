...
package com.oimchat.client.platform.fx.run.initializer.launch.essential;

import java.util.ArrayList;
import java.util.List;

import com.oimchat.client.platform.fx.run.watch.chat.GroupChatWatch;
import com.oimchat.client.platform.fx.run.watch.chat.GroupUnreadWatch;
import com.oimchat.client.platform.fx.run.watch.chat.UserChatWatch;
import com.oimchat.client.platform.fx.run.watch.chat.UserUnreadWatch;
import com.oimchat.client.platform.fx.run.watch.contact.ContactWatch;
import com.oimchat.client.platform.fx.run.watch.group.GroupApplyWatch;
import com.oimchat.client.platform.fx.run.watch.inform.GeneralApplyUnreadWatch;
...
public class WathInitializer implements LaunchInitializer {

	@Override
	public void initialize(AppContext appContext) {
		appContext.getObject(UserChatWatch.class);
		appContext.getObject(UserUnreadWatch.class);

		appContext.getObject(GroupChatWatch.class);
		appContext.getObject(GroupUnreadWatch.class);

		appContext.getObject(ContactWatch.class);
		appContext.getObject(GeneralApplyUnreadWatch.class);

		appContext.getObject(GroupApplyWatch.class);
	}
