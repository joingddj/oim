...
package com.oimchat.client.general.run.initializer.enter.essential;

import java.util.ArrayList;
import java.util.List;

import com.oimchat.client.general.kernel.work.common.cleaner.WorCleanerBox;
...
public class EssentialReentryInitializer implements EnterInitializer {

	@Override
	public void initialize(AppContext appContext) {
		WorCleanerBox box = appContext.getObject(WorCleanerBox.class);
		box.initialize();
	}
