...
package com.oimchat.client.platform.fx.run.initializer.enter.essential;
...
import com.oimchat.client.platform.fx.work.im.converge.RecentChatConverge;
...
public class DataInitializer implements EnterInitializer {

	@Override
	public void initialize(AppContext appContext) {
		MainPaneViewWrap mpvs = appContext.getObject(MainPaneViewWrap.class);
		mpvs.initializeData();
		...
		Runnable run = () -> {
			...
			try {
				...
				PersonalGroupMemberService gms = appContext.getObject(PersonalGroupMemberService.class);
				gms.loadAllJoined();

				Thread.sleep(1000);
				GeneralApplyInformationConverge informationConverge = appContext.getObject(GeneralApplyInformationConverge.class);
				informationConverge.refreshContactApplyNotice();

				Thread.sleep(1000);
				informationConverge.refreshGroupInviteeNotice();

				Thread.sleep(1000);
				informationConverge.refreshGroupInviteNotice();

				Thread.sleep(1000);
				informationConverge.refreshGroupJoinNotice();

				Thread.sleep(1000);
				RecentChatConverge recentChatConverge = appContext.getObject(RecentChatConverge.class);
				recentChatConverge.load();
			} catch (Exception e) {
