...
import com.onlyxiahui.app.view.fx.component.icon.font.constant.FontIconConstant;

import javafx.scene.text.Font;

/**
 * materialdesignicons 图标按钮 <br>
...
public class MaterialDesignIconButton extends FontIconButton {

	public final static String TTF_PATH = "/com/onlyxiahui/app/view/fx/default/font/icon/mdw/5.9.55/materialdesignicons-webfont.ttf";
	static Font font;
	static {
		try {
			font = Font.loadFont(MaterialDesignIconButton.class.getResource(TTF_PATH).openStream(), FontIconConstant.fontSize);
		} catch (IOException ex) {
			Logger.getLogger(MaterialDesignIconButton.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	public MaterialDesignIconButton() {
		initComponent();
	}

	private void initComponent() {
		this.setIconFont(font);
	}
}
