...
package com.onlyxiahui.app.view.fx.basic.node;

import javafx.scene.Node;

/**
 * Description <br>
 * Date 2020-11-19 21:22:51<br>
 * 
 * @author XiaHui [onlovexiahui@qq.com]<br>
 * @since 1.0.0
 */

public class NodeLoad<T extends Node> {

	T node;
	NodeGet<T> ng;

	public NodeLoad(NodeGet<T> ng) {
		this.ng = ng;
	}

	public void set(NodeSet<T> st) {
		st.set(get());
	}

	private synchronized T get() {
		return null == node ? node = ng.get() : node;
	}
}
