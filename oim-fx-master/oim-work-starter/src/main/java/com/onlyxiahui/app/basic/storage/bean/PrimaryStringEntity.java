 ...
 * 
 **/
package com.onlyxiahui.app.basic.storage.bean;
 ...
 */
@MappedSuperclass
public class PrimaryStringEntity extends BaseEntity {
	/**
	 * 主键id
	 */
	@Id
	@Column(name = "id", unique = true, nullable = false, length = 40, updatable = false)
	private String id;
