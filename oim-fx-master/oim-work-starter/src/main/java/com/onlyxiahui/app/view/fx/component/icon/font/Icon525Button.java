...
public class Icon525Button extends FontIconButton {

	public final static String TTF_PATH = "/com/onlyxiahui/app/view/fx/default/font/icon/525icons.ttf";

	static {
		try {
			Font.loadFont(Icon525Button.class.getResource(TTF_PATH).openStream(), 10.0d);
		} catch (IOException ex) {
			Logger.getLogger(Icon525Button.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	public Icon525Button() {
		initComponent();
	}

	private void initComponent() {
		this.setIconFontFamily("525icons");
	}
}
