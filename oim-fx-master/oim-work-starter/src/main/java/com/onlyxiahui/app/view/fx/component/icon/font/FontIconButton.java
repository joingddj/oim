...
public class FontIconButton extends Button {
	...
	private static final String DEFAULT_STYLE_CLASS = "font-icon-button";

	private final Text fontIconText = new Text();
...
//    FontPosture posture, double size
	...
	private void initComponent() {
		...
		// this.getStylesheets().add("/com/onlyxiahui/app/view/fx/default/css/component/icon/font/FontIconText.css");
		this.getStyleClass().add(DEFAULT_STYLE_CLASS);
		this.setGraphic(fontIconText);
		fontIconText.getStyleClass().add("icon-text");

		// text.setStyle("-fx-fill:#1abc9c");
	}
	...
	public void setFontIcon(String icon) {
		fontIconText.setText(icon);
	}

	public Text getFontIconText() {
		return fontIconText;
	}
