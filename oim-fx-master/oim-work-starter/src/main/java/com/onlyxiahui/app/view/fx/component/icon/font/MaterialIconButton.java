...
public class MaterialIconButton extends FontIconButton {

	public final static String TTF_PATH = "/com/onlyxiahui/app/view/fx/default/font/icon/mi/4.0.0/MaterialIcons-Regular.ttf";
	static Font font;
	static {
		try {
			font = Font.loadFont(MaterialIconButton.class.getResource(TTF_PATH).openStream(), FontIconConstant.fontSize);
		} catch (IOException ex) {
			Logger.getLogger(MaterialIconButton.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
