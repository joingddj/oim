...
set jvmarg=-server -XX:+UseG1GC -XX:MaxGCPauseMillis=100 -XX:G1ReservePercent=20
set meta=-XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=320m
set heap=-Xms1g
set new=-XX:NewSize=1G -XX:MaxNewSize=10G
set survivor=-XX:SurvivorRatio=8 -XX:TargetSurvivorRatio=50%
set tenuring=-XX:MaxTenuringThreshold=2
set class_unload=-XX:+CMSClassUnloadingEnabled
rem set trace=-XX:-OmitStackTraceInFastThrow
...
set args=%jvmarg% %meta% %heap% %new% %survivor% %tenuring% %class_unload% %dump% %page%
