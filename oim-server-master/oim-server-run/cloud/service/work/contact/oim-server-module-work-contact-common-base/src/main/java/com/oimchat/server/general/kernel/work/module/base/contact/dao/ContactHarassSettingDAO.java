...
public class ContactHarassSettingDAO extends BaseDAO {
	...
	public ContactHarassSetting getByUserId(String userId) {
		...
		String sql = "select * from " + EntityUtil.getTableName(ContactHarassSetting.class) + " where userId=:userId";
	...
	public String getIdByUserId(String userId) {
		...
		String sql = "select id from " + EntityUtil.getTableName(ContactHarassSetting.class) + " where userId=:userId";
	...
	public boolean deleteByUserId(String userId) {
		...
		sql.append(" select * from " + EntityUtil.getTableName(ContactHarassSetting.class) + " where userId=:userId ");
		QueryWrapper queryWrapper = new QueryWrapper();
		queryWrapper.put("userId", userId);
