...
import com.oimchat.server.general.kernel.work.module.business.group.manager.GroupMemberExtendBusinessManager;
...
public class GroupMemberService {
	...
	@Autowired
	private GroupMemberExtendBusinessManager groupMemberExtendBusinessManager;
	...
	public List<GroupMember> queryList(GroupMemberBusinessQuery query, Page page) {
		return groupMemberExtendBusinessManager.queryList(query, page);
	}
